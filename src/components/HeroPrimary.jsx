        ...
        md:justify-end md:items-star md:pl-40"
            ...
            <div className="relative w-full max-w-7xl mx-auto px-4 md:px-6 md:pb-20">
                <div className="text-center md:text-left">
                    <h1 className="font-black text-white tracking-[-0.02em] leading-[0.92] text-4xl md:text-7xl" style={{fontFamily:"Inter, system-ui"}}>The Peak Collection</h1>
                    
                    <p className="mt-3 text-white md:mt-4 text-base md:text-lg">Push your performance with our prenium athletic wear</p>
                    <Link to="/collections" className="text-white mt-8 inline-block px-8 py-3 border border-white font-medium hover:bg-white hover:text-black transition-all duration-300">Shop now</Link>
                </div>
            </div>
        </section>
    );
